...
export default function SubscriptionCard({
  ...
  return (
    <div
className='bg-[#1d4226] text-white w-full max-w-[320px] h-[500px] rounded-xl p-8 flex flex-col shadow-[0px_6px_6px_#000]'    >
      <div className='mt-10 text-center'>
<h2 className={`text-3xl tracking-widest ${pixelifySans.className}`}>
  {type}
</h2>
      </div>
      ...
      <div className='mt-auto mb-6 flex justify-center'>
        ...
        >
          <span
  className={`text-5xl tracking-widest drop-shadow-md ${pixelifySans.className}`}
>
  BUY
</span>
        </button>
