...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    ...
    >
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    <a
                      className={`sm-panel-item relative font-semibold text-[2rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]
                          ${pathname === it.link ? 'sm-active-item' : ''}
                      `}
                      href={it.link}
      ...
      <style>{`
.sm-scope .sm-panel-item.sm-active-item {
  color: #367b38;
...
.sm-scope .sm-panel-item:not(.sm-active-item):hover {
